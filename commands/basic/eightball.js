...
class eightball extends commando.Command {
    constructor(client) {
        super(client, {
            ...
            description:
                "Arugula responds to a question with a response from the magic eightball.",
            details:
                "Arugula responds to a question specified by the user with an answer depending on her mood that day.",
            format: "<question>",
            examples: [
                "aru! eightball Is Vins#9790 best dev?",
                "aru! 8ball Is Arugula best bot?",
            ],
            args: [
                {
                    key: "question",
